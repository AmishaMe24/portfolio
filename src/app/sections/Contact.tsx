                ...
                <div className='flex flex-col md:flex-row justify-center items-center pt-16 '>
                    ...
                    >
                        <motion.div 
                            ...
                            viewport={{ once: true }}
                            className="flex block-inline pb-8"
                        >
                        ...
                        >
                            ...
                            <div className='pl-2'>
                                ...
                                <span className="text-gray-500">Virginia, United States</span>
                            </div>
                        </motion.div>
                    </motion.div>
                    <motion.div 
                    ...
                    >
                        <form className="space-y-6" onSubmit={handleSubmit}>
                            ...
                            <motion.button 
                                ...
                                whileTap={{ scale: 0.95 }}
                                type="submit" 
                                className="bg-[#7685d6] hover:bg-[#6E7DCE] text-white font-bold py-2 px-4 rounded transition-all duration-300 hover:shadow-lg"
                            >
                                Send Message
                            </motion.button>
                        </form>
